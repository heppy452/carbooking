$(document).ready(function(){
    ...
    $(document).on('click','#add_btn',function(e){
        ...
        if(kategori == "") { notifNoAuto("Silahkan Pilih Kategori"); return false;}
    ...
    $(document).on('click','#save_add_btn',function(e){
        ...
        if (jenis_pemesan==1){
             if(nik_input == "") { swal("Perhatian","Isi Nomor Induk Karyawan<br>","warning"); return false; }
        } else {
            if(nm_lengkap == "") { swal("Perhatian","Isi Nama Lengkap<br>","warning"); return false; }
        }
        if(nomor_hp == "") { swal("Perhatian","Isi Nomor Handphone<br>","warning"); return false; }
        ...
        if (kategori==3){ 
            ...
            if (jns_booking==1){
                if(tgl_jadwal_bkg == "") { validate += "Isi Tanggal Jadwal <br>"; } 
                if(keterangan_jam == "") { validate += "Isi Keterangan <br>"; } 
                if(keterangan_jam.length < minlength) { validate += "Keterangan harus lebih dari 15 karakter <br>"; }
            } else {
                if(dari_tgl_bkg == "") { swal("Perhatian","Isi Dari Tanggal ","warning"); return false; } 
                if(sampai_tgl_bkg == "") { swal("Perhatian","Isi Sampai Tanggal ","warning"); return false; } 
                if(keterangan_tanggal == "") { swal("Perhatian","Isi Keterangan ","warning"); return false; } 
                if(keterangan_tanggal.length < minlength) { swal("Perhatian","Keterangan harus lebih dari 15 karakter ","warning"); return false; }
            }
        } else if (kategori==1){
            ...
            var tgl_jadwal_mlt = $("input.tgl_jadwal_mlt").map(function(){return $(this).val();}).get();

            if(tgl_jadwal == "") { swal("Perhatian","Isi Tanggal Jadwal ","warning"); return false; }
            if(lokasi_penjemputan == "") { swal("Perhatian","Isi Lokasi Penjemputan ","warning"); return false; }
            if(lokasi_awal == "") { swal("Perhatian","Pilih Lokasi Keberangkatan ","warning"); return false; }
            if(lokasi_tujuan == "") { swal("Perhatian","Pilih Lokasi Tujuan ","warning"); return false; }
            if(keterangan == "") { swal("Perhatian","Isi Keterangan ","warning"); return false; }
            if(keterangan.length < minlength) { swal("Perhatian","Keterangan harus lebih dari 15 karakter ","warning"); return false; }
            
            if (pulang==1){
                var tgl_jadwal_plg        = $("#tgl_jadwal_plg").val();
                var lokasi_penjemputan_plg= $("#lokasi_penjemputan_plg").val();
                if(tgl_jadwal_plg == "") { swal("Perhatian","Isi Tanggal Pulang ","warning"); return false; }
                if(lokasi_penjemputan_plg == "") { swal("Perhatian","Isi Lokasi Penjemputan Pulang ","warning"); return false; }
            }
            if (typeof(tgl_jadwal_mlt)){
                var dari_pukul_mlt      = $("input.dari_pukul_mlt").map(function(){return $(this).val();}).get();
                var sampai_pukul_mlt    = $("input.sampai_pukul_mlt").map(function(){return $(this).val();}).get();
                var lokasi_penjemputan_mlt = $("input.lokasi_penjemputan_mlt").map(function(){return $(this).val();}).get();
                var lokasi_awal_mlt     = $(".lokasi_awal_mlt option:selected").map(function(){return $(this).val();}).get();
                var lokasi_tujuan_mlt   = $(".lokasi_tujuan_mlt option:selected").map(function(){return $(this).val();}).get();
                var keterangan_mlt      = $(".keterangan_mlt").map(function(){return $(this).val();}).get();
            ...
            $('#multitujuan').append(
                ...
                "<div class='col-lg-1'>"+
                    "<div class='form-group'>"+
                        ...
                        "<div class='input-group-append'><button row-id='"+row_id+"' class='btn btn-danger delete_tujuan'><i class='fa fa-trash'></i></button></div>"+
                    "</div>"+
                "</div>"+
                "<div class='col-lg-3'>"+
                    "<div class='form-group'>"+
            ...
            $('#multitujuan').append(
                ...
                "<div class='col-lg-2'>"+
                    "<div class='form-group'>"+
                        "<label class='control-label'>Dari </label>"+
                        "<div class='input-group'>"+
                            "<input class='form-control time' type='text' value='08:30' id='dari_pukul'>"+
                            "<div class='input-group-append'>"+
                                "<span class='input-group-text' id='basic-addon2'>"+
                                "<i class='fa fa-clock'></i>"+
                            "</div>"+
                ...
                "<div class='col-lg-2'>"+
                    "<div class='form-group'>"+
                        "<label class='control-label'>Sampai </label>"+
                        "<div class='input-group'>"+
                            "<input class='form-control time' type='text' value='08:30' id='sampai_pukul'>"+
                            "<div class='input-group-append'>"+
                                "<span class='input-group-text' id='basic-addon2'>"+
                                "<i class='fa fa-clock'></i>"+
                            "</div>"+
