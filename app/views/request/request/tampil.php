            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php if ($id->apr_dir != 0) { ?>
                        <table class="table">
                            <tr>
                                <td><?= $this->l_request->approve($id->apr_dir) ?></td>
                            </tr>
                            <tr>
                ...
                <div class="card-body">
                    ...
                    ?>
                        <table class="table">
                            ...
                            <tr>
                                <td><?php $nik = $this->m_request->nik_driver($id->id_driver);
                                    echo $this->m_request->nama_driver($nik); ?></td>
                            </tr>
                            <tr>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td><?php if ($id->apr_spv_tgl == 0000 - 00 - 00) {
                                    ...
                                    echo date('d-m-Y', strtotime($id->apr_spv_tgl));
                                } ?></td>
                        </tr>
                        <tr>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td><?php if ($id->apr_ga_tgl == 0000 - 00 - 00) {
                                    ...
                                    echo date('d-m-Y', strtotime($id->apr_ga_tgl));
                                } ?></td>
                        </tr>
                        <tr>
                            <td><?= $id->apr_ga_ket ?></td>
