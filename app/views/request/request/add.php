                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input class="form-control date1" placeholder="Pilih Tanggal" type="text" id="tgl_jadwal_bkg">
                                                ...
                                                <div class="row" id="by_tanggal" style="display: none">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input class="form-control date1" placeholder="Pilih Tanggal" type="text" id="dari_tgl_bkg">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text" id="basic-addon2">
                                                                        <i class="fa fa-calendar"></i>
                                                                    </span>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label class="control-label">Sampai </label>
                                                            <div class="input-group">
                                                                <input class="form-control date1" placeholder="Pilih Tanggal" type="text" id="sampai_tgl_bkg">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text" id="basic-addon2">
                                                                        <i class="fa fa-calendar"></i>
                                                                    </span>
                                                ...
                                                <div class="row" id="pulang_pergi" style="display: none">
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input class="form-control date1" placeholder="Pilih Tanggal" type="text" id="tgl_jadwal_plg">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text" id="basic-addon2">
                                                                        <i class="fa fa-calendar"></i>
                                                                    </span>
