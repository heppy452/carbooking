                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="jenis_pemesan">
                                <option value="1" <?php if($id->jns_pemesan == 1){echo ' selected="selected"';}?>>Karyawan</option>
                                <option value="2" <?php if($id->jns_pemesan == 2){echo ' selected="selected"';}?>>Non Karyawan</option>
                            </select>
                        </div>
                    </div>
                    <?php
