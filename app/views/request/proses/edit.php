                    ...
                    <div class="col-lg-12">
                        <div id="karyawan" style="display: <?= $tampil ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?= $this->m_proses->nama_driver($id->nik_karyawan) ?>" required="true" readonly="" id="nama_lengkap">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Perusahaan</label>
                                <input type="text" class="form-control" value="<?= $this->m_proses->nama_perusahaan($id->id_perusahaan) ?>" required="true" readonly="" id="company">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Departemen</label>
                                <input type="text" class="form-control" value="<?= $this->m_proses->nama_divisi($id->id_departement) ?>" required="true" readonly="" id="divisi">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
