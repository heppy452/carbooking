    ...
    ((DateFormatter = function (e) {
      ...
      getMonth: function (e) {
        var t,
          a = this;
        return (
          0 === (t = n(e, a.dateSettings.monthsShort) + 1) &&
            (t = n(e, a.dateSettings.months) + 1),
          t
        );
      },
                  ...
                  if (
                    ...
                    for (
                      s = r(this),
                        d =
                          C !== D && C !== g
                            ? String.fromCharCode(c <= C && C <= m ? C - l : C)
                            : "_",
                        (C !== D && C !== g) || !s || ((s -= 1), (d = "_"));
          ...
          C.id && H.attr("id", C.id),
            ...
            (H.setOptions = function (r) {
              ...
              (C = e.extend(!0, {}, C, r)),
                ...
                C.inline &&
                  ((U = !0), H.addClass("xdsoft_inline"), a.after(H).hide()),
                C.inverseButton &&
                ...
                C.minDate &&
                  /^[\+\-](.*)$/.test(C.minDate) &&
                  (C.minDate = n.formatDate(
                    Y.strToDateTime(C.minDate),
                    C.formatDate
                  )),
                C.maxDate &&
                  /^[\+\-](.*)$/.test(C.maxDate) &&
                  (C.maxDate = n.formatDate(
            ...
            H.data("options", C).on("touchstart mousedown.xdsoft", function (
              e
            ) {
              return (
                e.stopPropagation(), e.preventDefault(), G.hide(), V.hide(), !1
              );
            }),
            E.append(R),
            E.xdsoftScroller(C),
              ...
              (t.now = function (e) {
                ...
                (t.strToDateTime = function (e) {
                  ...
                  return e && e instanceof Date && t.isValidDate(e)
                    ? e
                    : ((o = /^([+-]{1})(.*)$/.exec(e)) &&
                        (o[2] = n.parseDate(o[2], C.formatDate)),
                      o && o[2]
                        ? ((a =
                        ...
                        : (r = e ? n.parseDate(e, C.format) : t.now()),
              ...
              clearTimeout(d),
                (d = setTimeout(function () {
                  ...
                  for (
                    ...
                    y < Y.currentTime.countDaysInMonth() ||
                    p.getDay() !== C.dayOfWeekStart ||
                    ...
                    (x = []),
                      ...
                      "[object RegExp]" ===
                        ...
                        ? x.push("xdsoft_disabled")
                        : -1 !==
                          C.disabledDates.indexOf(n.formatDate(p, C.formatDate))
                        ? x.push("xdsoft_disabled")
                        : -1 !== C.disabledWeekDays.indexOf(s)
                        ? x.push("xdsoft_disabled")
                        : a.is("[disabled]") && x.push("xdsoft_disabled"),
                      c && "" !== c[1] && x.push(c[1]),
                      Y.currentTime.getMonth() !== l &&
                        x.push("xdsoft_other_month"),
                      (C.defaultSelect || H.data("changed")) &&
                        n.formatDate(Y.currentTime, C.formatDate) ===
                          n.formatDate(p, C.formatDate) &&
                        x.push("xdsoft_current"),
                      n.formatDate(D, C.formatDate) ===
                        n.formatDate(p, C.formatDate) && x.push("xdsoft_today"),
                      (0 !== p.getDay() &&
                        6 !== p.getDay() &&
                        -1 ===
                          C.weekends.indexOf(n.formatDate(p, C.formatDate))) ||
                        x.push("xdsoft_weekend"),
                      void 0 !==
                        C.highlightedDates[n.formatDate(p, C.formatDate)] &&
                        ((i =
                          C.highlightedDates[n.formatDate(p, C.formatDate)]),
                        x.push(
                          void 0 === i.style
                  ...
                  if (
                    ...
                    I.find(".xdsoft_label span")
                      .eq(0)
                      .text(C.i18n[r].months[Y.currentTime.getMonth()]),
                    I.find(".xdsoft_label span")
                      .eq(1)
                      .text(Y.currentTime.getFullYear()),
                    (S = ""),
                    "",
                    (l = ""),
                    (m = function (t, r) {
                      ...
                      s.setHours(t),
                        ...
                        o.setMinutes(r),
                        (x = []),
                        (!1 !== C.minDateTime && C.minDateTime > o) ||
                        (!1 !== C.maxTime &&
                          Y.strtotime(C.maxTime).getTime() < s.getTime()) ||
                        (!1 !== C.minTime &&
                          Y.strtotime(C.minTime).getTime() > s.getTime())
                          ? x.push("xdsoft_disabled")
                          : (!1 !== C.minDateTime && C.minDateTime > o) ||
                            (!1 !== C.disabledMinTime &&
                              s.getTime() >
                                Y.strtotime(C.disabledMinTime).getTime() &&
                              !1 !== C.disabledMaxTime &&
                              s.getTime() <
                                Y.strtotime(C.disabledMaxTime).getTime())
                          ? x.push("xdsoft_disabled")
                          : a.is("[disabled]") && x.push("xdsoft_disabled"),
                        (i = new Date(Y.currentTime)).setHours(
                        ...
                        (C.initTime || C.defaultSelect || H.data("changed")) &&
                          ...
                          (C.defaultSelect || H.data("changed")
                            ? x.push("xdsoft_current")
                            : C.initTime && x.push("xdsoft_init_time")),
                        parseInt(D.getHours(), 10) === parseInt(t, 10) &&
                          parseInt(D.getMinutes(), 10) === parseInt(r, 10) &&
                          x.push("xdsoft_today"),
                        (S +=
                    ...
                    for (y = 0; y < C.allowTimes.length; y += 1)
                      m(
                        Y.strtotime(C.allowTimes[y]).getHours(),
                        (l = Y.strtotime(C.allowTimes[y]).getMinutes())
                      );
                  else
                  ...
                  for (
                    ...
                    o +=
                      '<div class="xdsoft_option ' +
                      (Y.currentTime.getMonth() === y ? "xdsoft_current" : "") +
                      '" data-value="' +
                      y +
                      '">' +
                      C.i18n[r].months[y] +
            ...
            R.on("touchend click.xdsoft", "div", function (t) {
              ...
              if (
                ((void 0 !== n && null !== n) ||
                  ((Y.currentTime = Y.now()), (n = Y.currentTime)),
            ...
            H.on("changedatetime.xdsoft", function (t) {
              ...
              .on("generate.xdsoft", function () {
                C.onGenerate &&
                  ...
                  U && (H.trigger("afterOpen.xdsoft"), (U = !1));
              })
                    ...
                    s
                      ? ((o = "fixed"),
                        n + H.outerHeight() > c + m
                          ...
                          : (n -= m))
                      : n + H[0].offsetHeight > c + m &&
                        (n = t.top - H[0].offsetHeight + 1),
                    n < 0 && (n = 0),
                  ...
                  (this.value = this.defaultValue),
                    (this.value &&
                      t
                        ...
                        .isValidDate(n.parseDate(this.value, C.format))) ||
                      t.data("changed", !1),
